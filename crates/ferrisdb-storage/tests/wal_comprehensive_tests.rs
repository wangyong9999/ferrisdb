...
#[test] fn test_wal_buffer_many() { let b = WalBuffer::new(65536); for _ in 0..100 { b.write(b"record").unwrap(); } assert!(b.write_pos() > 0, "write_pos should advance after writes"); }
